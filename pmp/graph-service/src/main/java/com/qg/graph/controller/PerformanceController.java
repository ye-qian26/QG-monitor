...
public class PerformanceController {
    ...
    public Result selectByCondition(@RequestParam String platform, @RequestParam String projectId,
        ...
        switch (platform) {
            ...
            case "frontend":
                return frontendClient.selectFrontPerformanceByCondition(projectId, captureType);
            case "mobile":
                return mobileClient.selectMobilePerformanceByCondition(projectId, osVersion);
            case "all":
