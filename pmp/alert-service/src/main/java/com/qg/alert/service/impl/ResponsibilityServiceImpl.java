...
import com.qg.feign.domain.vo.BackendErrorHandleVO;
import com.qg.feign.domain.vo.FrontendErrorHandleVO;
import com.qg.feign.domain.vo.MobileErrorHandleVO;
...
public class ResponsibilityServiceImpl implements ResponsibilityService {
    ...
    private Result saveOrUpdateResponsibility(Responsibility responsibility, String platform) {
        ...
        if (result > 0) {
            ...
            return new Result(SUCCESS, "委派任务成功");
        } else {
