...
public interface RoleService {
    ...
    List<Role> getRoleListByProjectId(String projectId);

    Role getReceiverRoleInProject(String projectId, Long userId);

    List<Role> getTheRoleListInProject(String projectId, Integer userRole);
}
