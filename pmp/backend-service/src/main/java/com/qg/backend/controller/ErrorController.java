...
//    private ErrorService errorService;
    ...
    public Result selectByCondition(@RequestParam String projectId,
        ...
        switch (platform) {
            ...
            case "frontend":
                return backendClient.selectFrontResponsibilityByCondition(projectId, errorType);
            case "mobile":
                return backendClient.selectMobileResponsibilityByCondition(projectId, errorType);
            default:
