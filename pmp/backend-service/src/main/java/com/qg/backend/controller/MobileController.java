...
import com.qg.backend.service.MobilePerformanceService;
import com.qg.backend.service.MobileResponsibilityService;
...
public class MobileController {
    ...
    public Result selectMobileResponsibilityByCondition(@RequestParam String projectId, @RequestParam(required = false) String type) {
    ...
    public Result selectMobilePerformanceByCondition(@RequestParam String projectId, @RequestParam(required = false) String type) {
    ...
    public List<MobileError> getMobileErrorByErrorId(@RequestParam Long errorId) {
        return mobileErrorService.getMobileErrorByErrorId(errorId);
    }
    ...
    public List<MobileError> getMobileErrorByErrorType(@RequestParam List<String> errorTypes, @RequestParam String projectId) {
        return mobileErrorService.getMobileErrorByErrorType(errorTypes, projectId);
    }
}
